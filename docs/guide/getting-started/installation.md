...
| 平台 | 架构 | 下载 |
|------|------|------|
| Windows | AMD64 | [tpclaw-v1.0.8-windows-amd64-embed.zip](https://gitee.com/rulego/tpclaw/releases/download/v1.0.8/tpclaw-v1.0.8-windows-amd64-embed.zip) |
| Linux | AMD64 | [tpclaw-v1.0.8-linux-amd64-embed.tar.gz](https://gitee.com/rulego/tpclaw/releases/download/v1.0.8/tpclaw-v1.0.8-linux-amd64-embed.tar.gz) |
| Linux | ARM64 | [tpclaw-v1.0.8-linux-arm64-embed.tar.gz](https://gitee.com/rulego/tpclaw/releases/download/v1.0.8/tpclaw-v1.0.8-linux-arm64-embed.tar.gz) |
| macOS | ARM64 | [tpclaw-v1.0.8-darwin-arm64-embed.tar.gz](https://gitee.com/rulego/tpclaw/releases/download/v1.0.8/tpclaw-v1.0.8-darwin-arm64-embed.tar.gz) |
| macOS | AMD64 | [tpclaw-v1.0.8-darwin-amd64-embed.tar.gz](https://gitee.com/rulego/tpclaw/releases/download/v1.0.8/tpclaw-v1.0.8-darwin-amd64-embed.tar.gz) |
...
1. **解压文件**
   ...
   右键点击下载的 `tpclaw-v1.0.8-windows-amd64-embed.zip` 文件，选择"解压到当前文件夹"或使用解压软件解压。
...
1. **解压文件**
   ...
   ```bash
   # AMD64
   tar -xzf tpclaw-v1.0.8-linux-amd64-embed.tar.gz

   # ARM64
   tar -xzf tpclaw-v1.0.8-linux-arm64-embed.tar.gz
   ```
